...
Use AGENTS.md in the project for instructions. For this workshop explicitly request reading memory.md and the completed skill; native skill setup is optional and should follow the current docs for your client.
...
[Universal steps](universal.md) · [Official documentation](https://developers.openai.com/codex/guides/agents-md). Documentation pointer checked 2026-09-07; live access and product-specific native features are not certified by this workshop.
