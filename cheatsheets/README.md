...
Arrived without Git, Python, or a working account? Start with the repository's [zero-prep path](../README.md#i-arrived-with-nothing) and [troubleshooting guide](../docs/TROUBLESHOOTING.md). Switch lanes after five minutes rather than debugging through the exercise.
