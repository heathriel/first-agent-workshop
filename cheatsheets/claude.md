...
Module 3: `.claude/skills/meeting-summary/SKILL.md`; invoke `/meeting-summary`. `/mcp` inspects configured connectors. The core exercise uses the local file-reading tool; MCP is optional.
