# Grok-backed assistant lane

A model name or account does not establish file, MCP, or subagent support. Use the universal lane unless your installed host passes the file preflight. This workshop makes no claim about Grok Build access or subagent counts.
...
[Universal steps](universal.md) · [Official documentation](https://docs.x.ai/). Documentation pointer checked 2026-09-07; live access and product-specific native features are not certified by this workshop.
